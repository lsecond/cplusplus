...
6, ISBNPrefix(const ISBNPrefix& source);(private)
7, ISBNPrefix& operator=(const ISBNPrefix& source);(private);
*************************************************/
#include <iostream>
#include <cstring>
#include <fstream>
...
//a copy constructor that receives a reference to an ISBNPrefix object.
